...
async function mockRoutes(fastify) {
    // Mock sQuid service
    fastify.post('/squid/api/v1/verify', async (_request, reply) => {
        return reply.send({
            status: 'ok',
    ...
    fastify.post('/qonsent/api/v1/check', async (_request, reply) => {
        return reply.send({
            status: 'ok',
    ...
    // Mock Qmask service
    fastify.post('/qmask/api/v1/mask/apply', async (_request, reply) => {
        return reply.send({
            status: 'ok',
    ...
    fastify.post('/qerberos/api/v1/audit', async (_request, reply) => {
        return reply.send({
            status: 'ok',
            code: 'AUDIT_LOGGED',
    ...
    // Mock Qindex service
    fastify.post('/qindex/api/v1/put', async (_request, reply) => {
        return reply.send({
            status: 'ok',
            code: 'INDEXED',
    ...
    fastify.post('/qmarket/api/v1/list', async (_request, reply) => {
        return reply.send({
            status: 'ok',
            code: 'LISTED',
