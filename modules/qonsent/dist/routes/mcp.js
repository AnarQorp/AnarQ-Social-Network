...
const mcpRoutes = async (fastify) => {
    ...
    fastify.post('/tools/qonsent.check', {
        ...
        try {
            ...
            logger_1.logger.error('MCP permission check failed', { error, body: request.body });
            throw error;
        }
    });
    ...
    fastify.post('/tools/qonsent.grant', {
        ...
        try {
            ...
            logger_1.logger.error('MCP permission grant failed', { error, body: request.body });
            throw error;
        }
    });
    ...
    fastify.post('/tools/qonsent.revoke', {
        ...
        try {
            const { resource, identity, permissions } = request.body;
            ...
            logger_1.logger.error('MCP permission revocation failed', { error, body: request.body });
            throw error;
        }
    });
