...
export class AutoScalingManager extends EventEmitter {
     ...
     */
    async executeScalingAction(type, triggeredBy, targetNodes = [], parameters = {}) {
     ...
     */
    async generateOptimizations(nodeId) {
        const optimizations = [];
     ...
     */
    async getCapacityForecast(timeHorizon = 'P30D') {
    ...
    async executeTriggeredAction(policy, trigger) {
    ...
    async calculateActionImpact(action) {
    ...
    async getCurrentNodeConfiguration(nodeId) {
    ...
    async analyzeResourceUtilization(nodeId) {
    ...
    async optimizeCPU(nodeId, currentConfig, utilization) {
    ...
    async optimizeMemory(nodeId, currentConfig, utilization) {
    ...
    async optimizeDisk(nodeId, currentConfig, utilization) {
    ...
    async generateCapacityForecast(timeHorizon) {
...
//# sourceMappingURL=AutoScalingManager.js.map