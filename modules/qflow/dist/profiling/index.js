 ...
 */
export { PerformanceProfiler, RegressionDetector } from './PerformanceProfiler';
export { OptimizationEngine } from './OptimizationEngine';
export { AdvancedRegressionDetector } from './RegressionDetector';
...
export function createProfilingSystem(config) {
    ...
    const dashboard = new PerformanceDashboard(config.dashboard, profiler, regressionDetector, optimizationEngine);
    return {
        profiler,
        regressionDetector,
        optimizationEngine,
