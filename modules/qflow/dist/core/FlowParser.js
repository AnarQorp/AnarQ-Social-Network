...
import { FLOW_DEFINITION_SCHEMA } from '../models/FlowDefinition.js';
...
export class FlowParser {
     ...
     */
    parseFlow(flowData, format = 'auto') {
        const errors = [];
        const warnings = [];
        try {
     ...
     */
    async invalidateCachedFlow(flowId) {
        try {
