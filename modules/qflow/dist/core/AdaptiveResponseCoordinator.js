...
export class AdaptiveResponseCoordinator extends EventEmitter {
     ...
     */
    async triggerEmergencyResponse(reason, context) {
     ...
     */
    async forceAdaptiveAction(actionType, parameters) {
    ...
    async coordinateAdaptiveResponses() {
    ...
    async coordinateEmergencyActions() {
    ...
    async coordinateCriticalActions() {
    ...
    async coordinateProactiveActions() {
    ...
    async coordinateMaintenanceActions() {
    ...
    async executeEmergencyActions(reason, context) {
    ...
    async executeEmergencyAction(action, context, priority) {
    ...
    async handlePerformanceGateFailure(event) {
...
//# sourceMappingURL=AdaptiveResponseCoordinator.js.map