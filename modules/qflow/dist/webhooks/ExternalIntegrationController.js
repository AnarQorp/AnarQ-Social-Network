...
export class ExternalIntegrationController {
     ...
     */
    async createExternalSystem(req, res) {
        try {
     ...
     */
    async listExternalSystems(req, res) {
        try {
     ...
     */
    async getExternalSystem(req, res) {
        try {
     ...
     */
    async executeExternalCall(req, res) {
        try {
            const { systemId } = req.params;
            ...
            const result = await externalIntegrationService.executeExternalCall(systemId, callData.endpoint, callData.method, callData.data, callData.options);
            res.json({
                success: true,
                data: {
                    result,
     ...
     */
    async getIntegrationTemplates(req, res) {
        try {
            const { systemType } = req.query;
            const templates = externalIntegrationService.getIntegrationTemplates(systemType);
            res.json({
                success: true,
                data: {
                    templates,
     ...
     */
    async createIntegrationTemplate(req, res) {
        try {
