...
export class EcosystemModuleIntegration extends EventEmitter {
     ...
     */
    async callModuleEndpoint(request) {
        ...
        try {
            ...
            const result = await this.executeWithRetry(() => this.makeModuleCall(service, request), request.retryPolicy);
     ...
     */
    async sendCrossModuleEvent(event) {
        try {
            const fullEvent = {
                ...event,
                eventId: this.generateEventId(),
     ...
     */
    subscribeToEvents(moduleId, eventTypes) {
     ...
     */
    validateEndpointParameters(endpoint, parameters) {
     ...
     * Make module call
     */
    async makeModuleCall(service, request) {
     ...
     */
    async handleModuleRegistered(event) {
        try {
     ...
     */
    handleModuleUnregistered(event) {
        try {
            const { moduleId } = event.data;
     ...
     */
    handleModuleHealthChanged(event) {
        try {
...
//# sourceMappingURL=EcosystemModuleIntegration.js.map