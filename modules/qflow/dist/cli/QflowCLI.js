...
export class QflowCLI {
    ...
    async handleCreateFlow(file, options) {
        try {
    ...
    async handleListFlows(options) {
        try {
            ...
            const flows = []; // Would fetch from API
            if (flows.length === 0) {
    ...
    async handleUpdateFlow(id, file, options) {
        try {
    ...
    async handleDeleteFlow(id, options) {
        try {
            if (!options.yes) {
    ...
    async handleValidateFlow(file, options) {
        try {
    ...
    async handleStartExecution(flowId, options) {
        try {
    ...
    async handleListExecutions(options) {
        try {
    ...
    async handleExecutionStatus(id, options) {
        try {
    ...
    async handleExecutionLogs(id, options) {
        try {
    ...
    async handleResumeExecution(id) {
        try {
    ...
    async handleAbortExecution(id, options) {
        try {
            if (!options.yes) {
    ...
    async handleStartServer(options) {
        try {
    ...
    async handleTransferOwnership(flowId, newOwner, options) {
        try {
    ...
    async handleGrantPermission(flowId, identity, permission, options) {
        try {
    ...
    async handleRevokePermission(flowId, identity, permission) {
        try {
    ...
    async handleShowOwnership(flowId) {
        try {
    ...
    async handleRequestAccess(flowId, permissions, options) {
        try {
    ...
    async handleReviewRequest(requestId, decision, options) {
        try {
    ...
    async handleUpdatePolicy(flowId, options) {
        try {
            ...
            if (options.autoApprove) {
                policy.autoApprove = options.autoApprove.split(',').map((p) => p.trim());
            }
            if (options.requireApproval) {
                policy.requireApproval = options.requireApproval.split(',').map((p) => p.trim());
            }
    ...
    async handleListOwned(identity) {
        try {
    ...
    async handleListAccessible(identity, options = {}) {
        try {
            const targetIdentity = identity || 'current-user';
...
//# sourceMappingURL=QflowCLI.js.map